...
namespace Tyuiu.KirichokEV.Sprint6.Task4.V24
{
    public partial class FormMain : Form
    {
        ...
        private void buttonSave_KEV_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Сбой при сохарнении файла", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void buttonDone_KEV_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Таск 4 выполнила студентка группы РППб-24-1 Киричок Елизавета Викторовна", "Ошибка");
        }
    }
}
